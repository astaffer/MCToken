...
namespace MastercardApi.Client.Api
{
    ...
    public interface IPushAccountApiSync : IApiAccessor
    {
        ...
        /// <param name="pushAccountRequest">A Push Account request is used to trigger the push of a Card or Financial Account to a target Token Requestor  (optional)</param>
        /// <returns>PushAccountResponse</returns>
        PushAccountResponse PushAccount(PushAccountRequest pushAccountRequest = default(PushAccountRequest));
        ...
        /// <exception cref="MastercardApi.Client.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="pushAccountRequest">A Push Account request is used to trigger the push of a Card or Financial Account to a target Token Requestor  (optional)</param>
        /// <returns>ApiResponse of PushAccountResponse</returns>
        ApiResponse<PushAccountResponse> PushAccountWithHttpInfo(PushAccountRequest pushAccountRequest = default(PushAccountRequest));
    ...
    public interface IPushAccountApiAsync : IApiAccessor
    {
        ...
        /// <returns>Task of PushAccountResponse</returns>
        System.Threading.Tasks.Task<PushAccountResponse> PushAccountAsync(PushAccountRequest pushAccountRequest = default(PushAccountRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="pushAccountRequest">A Push Account request is used to trigger the push of a Card or Financial Account to a target Token Requestor  (optional)</param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PushAccountResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<PushAccountResponse>> PushAccountWithHttpInfoAsync(PushAccountRequest pushAccountRequest = default(PushAccountRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class PushAccountApi : IPushAccountApi
    {
        ...
        /// <returns></returns>
        public PushAccountApi(MastercardApi.Client.Client.Configuration configuration)
        {
        ...
        public PushAccountApi(MastercardApi.Client.Client.ISynchronousClient client, MastercardApi.Client.Client.IAsynchronousClient asyncClient, MastercardApi.Client.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="pushAccountRequest">A Push Account request is used to trigger the push of a Card or Financial Account to a target Token Requestor  (optional)</param>
        /// <returns>PushAccountResponse</returns>
        public PushAccountResponse PushAccount(PushAccountRequest pushAccountRequest = default(PushAccountRequest))
        {
            MastercardApi.Client.Client.ApiResponse<PushAccountResponse> localVarResponse = PushAccountWithHttpInfo(pushAccountRequest);
        ...
        /// <param name="pushAccountRequest">A Push Account request is used to trigger the push of a Card or Financial Account to a target Token Requestor  (optional)</param>
        /// <returns>ApiResponse of PushAccountResponse</returns>
        public MastercardApi.Client.Client.ApiResponse<PushAccountResponse> PushAccountWithHttpInfo(PushAccountRequest pushAccountRequest = default(PushAccountRequest))
        {
            ...
            localVarRequestOptions.Data = pushAccountRequest;


            // make the HTTP request
            var localVarResponse = this.Client.Post<PushAccountResponse>("/connect/1/0/pushAccount", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PushAccountResponse</returns>
        public async System.Threading.Tasks.Task<PushAccountResponse> PushAccountAsync(PushAccountRequest pushAccountRequest = default(PushAccountRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            MastercardApi.Client.Client.ApiResponse<PushAccountResponse> localVarResponse = await PushAccountWithHttpInfoAsync(pushAccountRequest, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PushAccountResponse)</returns>
        public async System.Threading.Tasks.Task<MastercardApi.Client.Client.ApiResponse<PushAccountResponse>> PushAccountWithHttpInfoAsync(PushAccountRequest pushAccountRequest = default(PushAccountRequest), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<PushAccountResponse>("/connect/1/0/pushAccount", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
